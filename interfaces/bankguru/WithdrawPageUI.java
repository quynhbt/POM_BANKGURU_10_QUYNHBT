...
public class WithdrawPageUI {
	...
	public static final String WITHDRAW_SUBMIT_BUTTON = "//input[@name='AccSubmit']";
	public static final String WITHDRAW_RESET_BUTTON = "//input[@name='res']";
	...
	public static final String FUND_TRANSFER = "//a[text()='Fund Transfer']";
}